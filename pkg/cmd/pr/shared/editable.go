...
func (e Editable) TitleParam() *githubv4.String {
	...
	s := githubv4.String(e.Title.Value)
	return &s
}
...
func (e Editable) BodyParam() *githubv4.String {
	...
	s := githubv4.String(e.Body.Value)
	return &s
}
...
func (e Editable) AssigneesParam(client *api.Client, repo ghrepo.Interface) (*[]githubv4.ID, error) {
	...
	return toParams(e.Assignees.Value, e.Metadata.MembersToIDs)
}
...
func (e Editable) LabelsParam() (*[]githubv4.ID, error) {
	...
	return toParams(e.Labels.Value, e.Metadata.LabelsToIDs)
}
...
func (e Editable) ProjectsParam() (*[]githubv4.ID, error) {
	...
	return toParams(e.Projects.Value, e.Metadata.ProjectsToIDs)
}
...
func (e Editable) MilestoneParam() (*githubv4.ID, error) {
	...
	return toParam(e.Milestone.Value, e.Metadata.MilestoneToID)
}
...
func FieldsToEditSurvey(editable *Editable) error {
	...
	results, err := multiSelectSurvey("What would you like to edit?", opts, []string{})
	if err != nil {
		return err
	}
...
func multiSelectSurvey(message string, options, defaults []string) ([]string, error) {
	if len(options) == 0 {
		return nil, nil
	}
	var results []string
